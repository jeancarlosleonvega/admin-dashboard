        ...
        <div className="px-6 pb-6">
          <TabPanel id="general" activeTab={activeTab}>
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <DetailSection title="Metadatos" description="Información del sistema." noBorder>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="label">Creado el</label>
                    <input type="text" className="input bg-gray-50" value={new Date(venue.createdAt).toLocaleString('es-AR')} readOnly />
                  </div>
                  <div>
                    <label className="label">Actualizado el</label>
                    <input type="text" className="input bg-gray-50" value={new Date(venue.updatedAt).toLocaleString('es-AR')} readOnly />
                  </div>
                </div>
                {canEdit && isDirty && (
          ...
          <TabPanel id="configuracion" activeTab={activeTab}>
            <form onSubmit={handleSubmit(onSubmit)}>
              <DetailSection title="Configuración" description="Configuración del espacio (sobreescribe los valores del tipo de deporte).">
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="cfg-interval" className="label">
                        Intervalo (min)
                        {selectedSportType && (
                    ...
                    <div>
                      <label htmlFor="cfg-players" className="label">
                        Jugadores por turno
                        {selectedSportType && (
                    ...
                    <div>
                      <label htmlFor="cfg-open" className="label">
                        Hora de apertura
                        {selectedSportType && (
                    ...
                    <div>
                      <label htmlFor="cfg-close" className="label">
                        Hora de cierre
                        {selectedSportType && (
