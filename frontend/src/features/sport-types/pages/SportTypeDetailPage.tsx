              ...
              <DetailSection title="Metadatos" description="Información del sistema." noBorder>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" className="input bg-gray-50" value={new Date(sportType.createdAt).toLocaleString('es-AR')} readOnly />
                  </div>
                  <div>
                    <label className="label">Actualizado el</label>
                    <input type="text" className="input bg-gray-50" value={new Date(sportType.updatedAt).toLocaleString('es-AR')} readOnly />
                  </div>
                </div>
                {canEdit && isDirty && (
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <DetailSection title="Configuración por defecto" description="Valores predeterminados que heredan los espacios de este tipo.">
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="cfg-interval" className="label">Intervalo (minutos)</label>
                      <input
                        id="cfg-interval"
                        type="number"
                        min={5}
                    ...
                    <div>
                      <label htmlFor="cfg-players" className="label">Jugadores por turno</label>
                      <input
                        id="cfg-players"
                        type="number"
                        min={1}
                    ...
                    <div>
                      <label htmlFor="cfg-open" className="label">Hora de apertura</label>
                      <input
                        id="cfg-open"
                        type="time"
                    ...
                    <div>
                      <label htmlFor="cfg-close" className="label">Hora de cierre</label>
                      <input
                        id="cfg-close"
                        type="time"
